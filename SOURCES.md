...
| libwebsockets | `websockets` | `main` snapshot | `fd1e670ea3f20859592c5ea2321560e1d37444c0` | https://github.com/warmcat/libwebsockets | MIT | WebSocket client support | Plugins, examples, test applications, contributed code, documentation assets, and CI files omitted. |
| LuaJIT | `luajit` | `2.1` rolling release | `2460b3ff93a1c955de3d62cfc825de7d68dc272e` | https://github.com/LuaJIT/LuaJIT | MIT | Lua 5.1-compatible runtime and JIT | Complete runtime source and build tools retained; this is the sole Lua runtime implementation. |
| tolua++ | `tolua` | `1.0.93` | `9feb31ab8b97eda9561846508ee9e3a2caff8da7` | https://github.com/LuaDist/toluapp | MIT | C++ Lua bindings | Runtime library, public header, license, and README retained; generator, tests, packaging, and IDE projects omitted. |
